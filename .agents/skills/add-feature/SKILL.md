...
3. Identificar o módulo afetado, os padrões existentes e a menor alteração que atende aos critérios de aceite.
4. Seguir o fluxo incremental e orientado a testes definido no workflow, mantendo as dependências apontadas para dentro.
5. Executar testes, lint, formatação e verificação de tipos relevantes.
6. Relatar arquivos alterados, decisões, validações e qualquer risco residual.
