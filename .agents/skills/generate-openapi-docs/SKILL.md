...
3. Inspecionar requisitos, casos de uso, modelos, rotas, schemas, autenticação e testes relacionados.
4. Aplicar o fluxo contract-first ou, para código existente, sincronizar contrato e implementação conforme o workflow.
5. Executar todas as validações relevantes indicadas pelo projeto e pelo workflow.
6. Relatar divergências, breaking changes e validações realizadas.
